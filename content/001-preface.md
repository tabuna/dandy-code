...
Вы можете прочитать её залпом за вечер — но вряд ли это принесёт реальную пользу.

Гораздо эффективнее — читать по одной-две главы за раз.
Применять на практике. Обсуждать с коллегами. Спорить. Переделывать старый код.

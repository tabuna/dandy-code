...
кодовой базой, эта книга тоже может быть полезной.
...
Мы не будем обсуждать coupling и cohesion, рассчитывать формулы maintainability или разбирать уровни абстракций.

...
Часто можно услышать, что код — это средство общения с компьютером: набор инструкций как «положи из X в Y».
...
Поэтому чем четче выражена мысль в коде, тем быстрее команда поймет, как он работает, тем проще сопровождать и развивать проект.

Давайте сменим установку: думать не о том, как код поймёт машина, а о том, как его воспримут коллеги и мы сами в будущем.

### Код — это тоже текст

Наша работа — это умственный труд, и результатом становятся тексты: код, документация, сообщения в коммитах и комментарии.
...
Дочитывать не хочется. Приглашать на собеседование — тем более.
...
Вот так выглядит проект, где два разработчика и полная свобода.
А теперь добавьте к ним в команду фаната "Звёздных войн", любителя Йода, обожателя аббревиатур и экономного комментатора.
Результат — код, который… ну, *"вроде работает"*, но никто не понимает, как именно.

И дело не в грамматике, не в запятых. Проблема глубже: **код теряет свою речь** и становиться полностью неестественным.
...
Единственный, кому действительно нужен ясный код — это высокомотивированный разработчик. Такой, как вы.

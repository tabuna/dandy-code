...
После беглого просмотра кода, первое что мы действительно читаем это имена переменных, методов и классов.
...
Это можеть быть как однобуквенные варианции `$i` или `q` так и сокращение 

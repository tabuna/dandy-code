...
Мы верим, что метод делает то, что обещает его имя. Мы верим, что класс отражает свою роль. Мы верим, что код говорит правду.
Но стоит нарушить это правило — и доверие рушится.
Имя, которое вводит в заблуждение, оставляет ощущение предательства: разработчик ожидал одно поведение, а получил другое. После этого каждый следующий метод он будет читать уже с подозрением.

...
Затем понадобиться изменить в части наследников нормализацию имен для городов. Кто-то добавит изменения в
...
Когда его будет недостаточно, или он разрастется, то замените на `callable` на интерфейс и передавайте объект реализующий его.

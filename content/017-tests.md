...
Ты запускаешь приложение, проверяешь, что оно работает, затем вносишь изменения и снова убеждаешься, что всё работает
как прежде.
...
Есть несколько способов, как организовать подготовку данных. Например, определить заранее записи в базе данных, которые
бы
